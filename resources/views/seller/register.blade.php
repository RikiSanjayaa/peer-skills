...
@section('content')
    {{-- TODO: add email notification for seller registration and approval confirmation --}}
                    ...
                    <div class="card-body p-5">
                        ...
                        <form method="POST" action="{{ route('seller.register') }}">
                            ...
                            <div class="mb-4">
                                            ...
                                            <div class="d-flex flex-wrap gap-2">
                                                @foreach ($categorySkills as $skill)
                                                    <label class="skill-badge" data-skill="{{ $skill->name }}">
                                                        <input type="checkbox" class="skill-checkbox d-none" name="skills[]"
                                                            value="{{ $skill->name }}"
                                ...
                                <div class="form-text">Pilih atau tambahkan keahlian yang paling menggambarkan keahlian
                                    Anda
                                    (maksimum
                                    10 total)</div>
                                @error('skills')
...
@push('scripts')
    <script>
        // Skill label handling with hidden checkbox
        document.querySelectorAll('.skill-badge').forEach(function(label) {
            const checkbox = label.querySelector('.skill-checkbox');
            ...
            label.addEventListener('click', function(e) {
                e.preventDefault(); // Prevent default label behavior (auto-toggle)
        ...
        addCustomSkillBtn.addEventListener('click', function() {
            ...
            skillTag.innerHTML =
                `${skillName} <input type="hidden" name="skills[]" value="${skillName}"><button type="button" class="btn-close btn-close-white btn-sm ms-1"></button>`;
        ...
        // No need for submit handler - checkboxes and hidden inputs handle form submission
